...
import type { GameDTO, LogicPuzzleDTO, MemoryCardDTO, QuizQuestionDTO, ReflexSettingsDTO } from '@/api/types';
                        ...
                        {reflexSettings ? (
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                            ...
                            {reflexSettings.modeleReflexe === 'GO_NO_GO' && (
                              <p className="text-gray-700"><span className="font-semibold text-gray-900">Ratio No-Go:</span> {reflexSettings.noGoRatio ?? '—'}%</p>
                            )}
