        ...
        <div style={styles.container}>
          <div style={styles.card}>
            ...
            <div style={styles.header}>
              ...
              <h1 style={styles.title}>Rejoins l'Aventure !</h1>
              <p style={styles.subtitle}>
                Crée ton compte <span style={styles.highlight}>Joueur</span> et commence à apprendre en t'amusant avec l'<span style={styles.highlight}>IA</span> ! 🎯
              </p>
            </div>
